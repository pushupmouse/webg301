 ...
 */
final class Version20220817025059 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE laptop ADD brand_id INT DEFAULT NULL, ADD category_id INT DEFAULT NULL, ADD origin_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE laptop DROP brand_id, DROP category_id, DROP origin_id');
    }
}
